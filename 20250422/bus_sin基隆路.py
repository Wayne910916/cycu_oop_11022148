...
def plot_bus_route(bus_data, output_image):
    ...
    # 設定地圖標題與圖例
    ax.set_title("公車路線圖", fontsize=16)
    ax.legend()
...
if __name__ == "__main__":
    # 指定 CSV 檔案路徑
    csv_file = r"C:\Users\User\Desktop\cycu_oop_11022148\0161001500_stops.csv"

    # 讀取公車站點資料
    bus_data = read_bus_data_from_csv(csv_file)

    # 指定輸出的圖片檔案名稱
    output_image = r"C:\Users\User\Desktop\cycu_oop_11022148\公車路線圖.jpg"
